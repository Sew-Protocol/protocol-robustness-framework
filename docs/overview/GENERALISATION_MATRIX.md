...
| Scenario analysis utilities (`scenario/*`) | **Medium-High** | **High** | Low-Medium | Mostly generic; some assumptions reflect current trace shape. |
...
| Use-of-funds output contract (`:funds-ledger-view`) | **Medium-High** | **High** | Medium | Output shape reusable; computation currently SEW-scoped. |
