...
| malicious-verdict-economically-bounded | Malicious resolver verdict | slashable-liability-preserved | malicious-resolver-verdict-v1, appeal-failure-cascade-v1 | pass | actual/evidence-matrix.json |
...
| yield-accrual-covers-protocol-fees | Fee drag on long escrows | yield-accrual-efficiency | yield-accrual-efficiency-v1 | pass | actual/evidence-matrix.json |
